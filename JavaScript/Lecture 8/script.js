...
.then(result=>{
    const{name,email,gender,picture}=result.results[0];
        ...
        <img src="${picture.large}" class="w-full h-full fit-cover" alt=""></div>
        ...
        <p class="mt-5 text-xs font-semibold opacity-80">
          ...
          nemo atque nesciunt provident est amet. Amet velit voluptate, quasi
          officiis laborum obcaecati dolores laboriosam non mollitia perferendis
          natus consectetur adipisci!
        </p>`
